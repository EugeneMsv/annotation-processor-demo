...
public class BuilderProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        for (TypeElement annotation : annotations) {
            ...
            Map<Boolean, List<Element>> annotatedMethods = extractAnnotatedMethods(roundEnv, annotation);
    ...
    private Map<Boolean, List<Element>> extractAnnotatedMethods(RoundEnvironment roundEnv, TypeElement annotation) {
